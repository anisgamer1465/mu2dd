...
const youtube = new YouTube("AIzaSyC9JgXB7EqcDdaWCMZ9DuMHcTK1mOWpyJM");
...
//:speaker: Volume changed from 20 to 20 ! The volume has been changed from ${queue.volume} to ${args[0]}
      ...
      if(queue.repeating) {
        ...
        return msg.channel.send(':arrows_counterclockwise: **Repeating Mode** (`OFF`)');
      } else {
        queue.repeating = true;
        return msg.channel.send(':arrows_counterclockwise: **Repeating Mode** (`ON`)');
      }
